...
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0.3.0   | <ul><li>Replaced the restricted ECMAScript execution contract with Taskmigo Policy Language.</li><li>Adopted the TPL default-exported function contract and JavaScript-like surface syntax without JavaScript runtime semantics.</li><li>Delegated typing, function analysis, evaluation, partial evaluation, and queryability semantics to the Policy Language SRS.</li></ul> |
