...
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.3.0   | <ul><li>Replaced the restricted ECMAScript execution contract with the Policy Language.</li><li>Adopted the direct policy-body contract without `export`, function, arrow-function, or module wrappers.</li><li>Moved authorization-specific roots and scope behavior into the Authorization SRS while keeping the Policy Language consumer-neutral.</li></ul> |
