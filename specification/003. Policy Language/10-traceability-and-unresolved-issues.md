...
The [Authorization feature](../002.%20Authorization/README.md) owns authorization effects, target matching, effective Statement resolution, Object filter composition, and persistence execution. TPL owns the source-language and typed evaluation semantics used by that feature.
...
Additional intrinsic functions and additional consumer-defined scalar types require their contracts to satisfy INTR-001, QUERY-002, and TYPE-001 before use; they do not require changing the core grammar unless new syntax is introduced.
