...
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1.0   | <ul><li>Defined Taskmigo Policy Language with JavaScript-like `function`, `export default`, `const`, `if (...)`, and `&&`/`||`/`!` surface syntax.</li><li>Defined static typing, source-declared zero-argument functions, partial evaluation, and query-lowering requirements for Object Authorization.</li><li>Excluded utility functions from the initial language.</li><li>Required an ANTLR-generated Java parser frontend.</li></ul> |
