...
| 3       | External Interface Requirements                   | Source syntax, environment, and compiled-policy interfaces            | [03-external-interface-requirements.md](03-external-interface-requirements.md)                   |
| 4       | Functional and Behavioral Requirements            | Typing, evaluation, partial evaluation, and query lowering            | [04-functional-and-behavioral-requirements.md](04-functional-and-behavioral-requirements.md)     |
...
| ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1.0   | <ul><li>Defined the Taskmigo Policy Language source, type, and evaluation contracts.</li><li>Defined partial evaluation and query-lowering requirements for Object Authorization.</li><li>Required an ANTLR-generated parser frontend.</li></ul> |
