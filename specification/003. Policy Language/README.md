...
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1.0   | <ul><li>Defined the Policy Language as a consumer-neutral single policy body using JavaScript-like `const`, `return`, `if (...)`, and `&&`/`||`/`!` surface syntax.</li><li>Defined static typing, direct evaluation, partial evaluation, consumer-provided Environment Schemas, and generic query-lowering requirements.</li><li>Excluded consumer-domain root/scope/effect semantics, `export`, user-defined functions, arrow functions, calls, and utility functions from the language.</li><li>Required an ANTLR-generated Java parser frontend.</li></ul> |
