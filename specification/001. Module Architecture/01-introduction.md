...
This Software Requirements Specification defines the mandatory Domain-Driven Design architecture for Taskmigo software. It establishes bounded-context ownership, tactical domain layering, dependency direction, the role of shared technical modules, and the automated mechanisms that enforce logical package boundaries.
...
- Require domain-oriented bounded contexts to separate domain semantics, application orchestration, and infrastructure or adapter implementation responsibilities.
- Require cross-context integration through published contracts or events rather than another context's internal packages or persistence tables.
...
- **Application Layer:** The layer that coordinates use cases, transactions, domain objects, ports, and published integration without owning domain invariants.
...
- **Infrastructure Layer:** Implementations of persistence, messaging, framework integration, external systems, and other technical ports owned by or adapting a bounded context.
...
[Section 2](02-overall-description.md) defines the DDD context model and physical-module mapping. [Section 4](04-functional-and-behavioral-requirements.md) defines normative context ownership and tactical architecture. [Section 7](07-constraints.md) defines mandatory domain, persistence, dependency, and boundary-enforcement constraints. [Section 8](08-requirements-allocation-and-dependencies.md) defines the normative context map and allowed dependency relationships.
